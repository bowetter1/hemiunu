...
# =============================================================================
# TEAMS - Förkonfigurerade team-uppsättningar
# =============================================================================
TEAMS = {
    "a-team": {
        "name": "A-Team",
        "description": "Premium: Opus + Haiku",
        "workers": {
            "chef": "opus",
            "ad": "haiku",
            "architect": "haiku",
    ...
    "groq-team": {
        "name": "Groq Team",
        "description": "Budget: Llama 70B (supersnabb)",
        "workers": {
            "chef": "groq-llama70",
            "ad": "groq-llama70",
            "architect": "groq-llama70",
            "backend": "groq-llama70",
            "frontend": "groq-llama70",
            "tester": "groq-llama70",
            "reviewer": "groq-llama70",
            "security": "groq-llama70",
            "devops": "groq-llama70",
        }
    },
}
...
def get_team_config(team: str) -> dict:
    """Get team configuration by name."""
    return TEAMS.get(team, TEAMS[DEFAULT_TEAM])


def get_worker_ai(worker: str, override: Optional[str] = None, team: Optional[str] = None) -> str:
    """Get AI type for a worker.

    Priority:
    1. Explicit override parameter
    2. Environment variable APEX_MODEL_{WORKER}
    3. Team configuration (if team specified)
    4. Default from ROLES
    """
    ...
    if team and team in TEAMS:
        ...
        return team_config["workers"].get(worker, "haiku")
