...
- **git_commit(message)** - add all changes and commit
- **git_status()** - check current git status
- **github_create_repo(name, description)** - create GitHub repo and push code
- **github_push()** - push new commits to GitHub
